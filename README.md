# Analysis code for 'Distinct mutational landscapes when comparing germline and somatic cancer variants in forty tumor suppressor genes'
...
## Contact: 
- Author 1: Suhasini Lulla (slulla@bcm.edu)
- Corresponding author: Sharon E. Plon (splon@bcm.edu)
