# cBioPortalR to extract somatic data from non-redundant studies in cBioPortal
...
## **Importing all samples in non-redundant studies (213 studies, listed in Table S3) \## code executed on 5/5/23:**
...
## **Binding all rows from 213 non-redundant studies to make a complete list of samples:**
...
## Ext**racting data from 40 TSGs for the list of samples in 213 studies** 

## **Saving individual gene files to local directory** 

## **(when using Python script to process data subsequently, these are the filenames called).**

##  **Dates code executed are in filenames in format M-DD-YY**
...
## **Exporting list of samples in extracted cbio data to remove from COSMIC data (saved 9/18/23):**
